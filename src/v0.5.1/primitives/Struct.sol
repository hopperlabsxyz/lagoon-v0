...
/// @param pendingAssets Total value of assets that were settled in this settlement.
/// @param pendingShares Total number of shares that were settled in this settlement.
struct SettleData {
    uint256 totalSupply;
    uint256 totalAssets;
