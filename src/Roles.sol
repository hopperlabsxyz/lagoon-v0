...
contract Roles is Ownable2StepUpgradeable {
    ...
    bytes32 private constant rolesStorage =
        0x7c302ed2c673c3d6b4551cf74a01ee649f887e14fd20d13dbca1b6099534d900; //todo compute proper storage slot
    ...
    function update_whitelistManager(
        address _whitelistManager
    ) external onlyOwner {
        _getRolesStorage().whitelistManager = _whitelistManager;
    }

    function update_feeReceiver(address _feeReceiver) external onlyOwner {
