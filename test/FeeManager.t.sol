...
contract TestFeeManager is BaseTest {
    ...
    function test_with_no_fees() public view {
      ...
      (uint256 managerFees, uint256 protocolFees) = vault.calculateProtocolFee(totalFees);
   ...
   function test_protocol_fees() public {
      ...
      (uint256 managerFees, uint256 protocolFees) = vault.calculateProtocolFee(_100M);
