...
contract VaultHelper is Vault {
    ...
    function lastDepositRequestId_debug(
        ...
        return ERC7540Lib._getERC7540Storage().lastDepositRequestId[controller];
    }
    ...
    function epochSettleId(
        ...
        return ERC7540Lib._getERC7540Storage().epochs[epochId].settleId;
    }

    function depositEpochId() public view returns (uint40) {
        return ERC7540Lib._getERC7540Storage().depositEpochId;
    }

    function redeemEpochId() public view returns (uint40) {
        return ERC7540Lib._getERC7540Storage().redeemEpochId;
    }

    function totalAssetsExpiration() public view returns (uint256) {
        return ERC7540Lib._getERC7540Storage().totalAssetsExpiration;
    }

    function totalAssetsLifespan() public view returns (uint256) {
        return ERC7540Lib._getERC7540Storage().totalAssetsLifespan;
    }
    ...
    function lastRedeemRequestId(
        ...
        return ERC7540Lib._getERC7540Storage().lastRedeemRequestId[controller];
    }
    ...
    function lastFeeTime() public view returns (uint256) {
        return FeeLib._getFeeManagerStorage().lastFeeTime;
    }
